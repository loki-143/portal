    ...
    <div className="min-h-screen bg-surface flex">
      ...
      <aside className="w-72 fixed h-screen bg-surface-container-low/30 hidden lg:flex flex-col z-40">
        <div className="p-8 mb-4">
          ...
          <p className="label-md text-on-surface-variant/50 text-[10px]">Recruitment Admin</p>
        </div>
        ...
        <div className="p-8 space-y-4">
          ...
          <div className="pt-8 border-t border-outline-variant/30 space-y-1">
            ...
            <button className="flex items-center gap-3 px-4 py-2 text-on-surface-variant/60 hover:text-error transition-colors text-sm font-medium">
        ...
        <header className="h-20 glass sticky top-0 z-50 flex items-center justify-between px-10">
          <div className="flex items-center gap-8">
            ...
            <div className="hidden md:flex items-center gap-6">
              <Link to="/" className="text-on-surface-variant hover:text-primary transition-colors font-medium">Talent Pool</Link>
              <Link to="/insights" className="text-on-surface-variant hover:text-primary transition-colors font-medium">Insights</Link>
              <Link to="/messages" className="text-on-surface-variant hover:text-primary transition-colors font-medium">Messages</Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-outline-variant/30">
              ...
              <div className="hidden sm:block">
                ...
                <p className="text-[10px] label-md text-on-surface-variant/50">Hiring Manager</p>
              </div>
