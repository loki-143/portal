    ...
    <div className="max-w-5xl mx-auto space-y-12">
      <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
        ...
        <div className="flex gap-4">
          <Button variant="ghost" className="bg-surface-container-low">Save Draft</Button>
            ...
            <div className="space-y-8">
              <div className="space-y-4">
                ...
                <div className="flex gap-2">
                  <button className="flex-1 py-3 bg-primary text-on-primary rounded-full font-bold text-sm">Active</button>
                  <button className="flex-1 py-3 bg-surface-container-low text-on-surface-variant/60 rounded-full font-bold text-sm hover:bg-surface-container-high transition-colors">Draft</button>
                </div>
              </div>
